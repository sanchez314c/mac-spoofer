    ...
    def get_interfaces(self):
        ...
        if self.system == 'darwin':  # macOS
            try:
                ...
                print(f"Warning: Could not list hardware ports: {e}")
                # Fallback
            ...
            try:
                ...
                print(f"Warning: Could not list network interfaces: {e}")
                # Fallback
            ...
            try:
                ...
                print(f"Note: Windows interface detection requires admin privileges: {e}")
    ...
    def get_current_mac(self, interface):
        ...
        try:
            if self.system == 'darwin':  # macOS
                ...
                # Read directly from sysfs instead of spawning cat
