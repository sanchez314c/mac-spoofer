class MACSpooferUI {
  ...
  async loadInterfaces() {
    ...
    interfaceList.innerHTML =
      '<div class="loading-spinner"><div class="spinner"></div><p>Loading interfaces...</p></div>';
  ...
  renderInterfaces() {
    ...
    if (this.interfaces.length === 0) {
      interfaceList.innerHTML =
        '<p class="no-interfaces">No network interfaces found</p>';
      return;
    }
  ...
  async loadStatus() {
    ...
    statusGrid.innerHTML =
      '<div class="loading-spinner"><div class="spinner"></div><p>Loading status...</p></div>';
    ...
    try {
      ...
      statusGrid.innerHTML =
        '<p class="error-message">❌ Failed to load interface status</p>';
    }
  }
  ...
  renderStatus() {
    ...
    if (this.statusData.length === 0) {
      statusGrid.innerHTML =
        '<p class="no-status">No interface status available</p>';
      return;
    }
