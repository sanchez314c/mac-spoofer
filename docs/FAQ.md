...
1. Go to the [Releases](https://github.com/sanchez314c/mac-spoofer/releases) page
...
**Still have questions? Check the [documentation index](./README.md) or open a new issue on GitHub.**
